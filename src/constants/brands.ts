...
const brands: BrandsT = {
  ...
  others: {
    // from https://en.wikibooks.org/wiki/Vehicle_Identification_Numbers_(VIN_codes)/World_Manufacturer_Identifier_(WMI)#cite_note-1
    "363": "Spyker",
    "795": "Bugatti",
    "935": "Citroën",
    "936": "Peugeot",
